...
# Recuerda verificar que esta clave sea tu llave 'anon' / 'public' correcta de Supabase
...
# Menú completo y exacto basado en el PDF e imágenes
MENU_INICIAL_COMPLETO = [
    # --- MENÚ BRUNCH (MAÑANA) [Con opción de bebida incluida] ---
    ...
    {"nombre": "Tostadas (Combo 4)", "precio": 25.0, "categoria": "Comida", "descripcion": "Tostadas fritas con frijol o aguacate, decoradas con salsa y queso.", "horario": "Ambos", "config_tamano": "ninguno", "admite_promo": False, "imagen": "https://images.unsplash.com/photo-1541544741938-0af808871cc0?w=400"},
    ...
    {"nombre": "Sándwich Croque", "precio": 30.0, "categoria": "Comida", "descripcion": "Pan relleno con bechamel, mozzarella, frijol o jamón, huevo estrellado y salsa de queso.", "horario": "Ambos", "config_tamano": "ninguno", "admite_promo": False, "imagen": "https://images.unsplash.com/photo-1521305916504-4a1121188589?w=400"},
    ...
    # --- MENÚ TARDE (ANTOJITOS Y POSTRES) ---
    ...
    {"nombre": "Latte", "precio": 25.0, "categoria": "Bebidas Calientes", "descripcion": "Disponible en caliente o frío.", "horario": "Ambos", "config_tamano": "elegir_ambos", "admite_promo": False, "imagen": "https://images.unsplash.com/photo-1570968915860-54d5c301fa9f?w=400"},
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if len(productos_actuales) == 0:
                ...
                print("¡Menú precargado exitosamente en Supabase!")
